        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          <div className="relative" ref={langMenuRef}>
            <button
              ...
              title="Đổi Ngôn Ngữ & Tiền Tệ (Language & Multi-Currency)"
            >
              ...
              <div className="absolute right-0 top-full mt-2 w-72 p-2.5 bg-[#090d16]/98 backdrop-blur-xl border border-cyan-500/60 rounded-xl shadow-[0_12px_40px_rgba(0,0,0,0.95)] z-50 animate-in fade-in zoom-in-95 duration-150">
                <div className="flex items-center justify-between pb-2 border-b border-slate-800 text-xs font-mono font-bold text-white">
                  <span className="flex items-center gap-1.5 text-cyan-400">
                    ...
                    <span>{t('select_language_title')}</span>
                  </span>
                  <button
                    onClick={() => {
                      setIsQuickLangOpen(false);
                ...
                {/* Language Grid */}
                <div className="grid grid-cols-2 gap-1 pt-2 pb-2.5 border-b border-slate-800/80">
                  {SUPPORTED_LANGUAGES.map((lang) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-left text-xs font-mono transition-all cursor-pointer ${
                          isSelected
                ...
                <div className="pt-2">
                  <div className="text-[10px] font-mono text-slate-400 mb-1.5 flex items-center justify-between">
                    <span>{t('select_currency_title')}:</span>
                ...
                <div className="grid grid-cols-2 gap-1.5 mt-2.5">
                  ...
                  <button
                    ...
                    title="Xem Cron Tỷ Giá Hàng Giờ (0 * * * *)"
                  >
          ...
          <button
            ...
            title="Mở toàn bộ thư mục tiện ích (18 công cụ)"
          >
            <Compass className="w-3 h-3 sm:w-3.5 sm:h-3.5 animate-spin" style={{ animationDuration: '10s' }} />
            <span className="font-black tracking-tight">{t('nav_folder_btn')}</span>
          </button>
          ...
          <button
            ...
            title="Kho Key & Tài Khoản đã mua"
          >
            <Key className="w-3.5 h-3.5 text-amber-400" />
            <span className="hidden sm:inline">{t('nav_key_vault')}</span>
            {activeOrdersCount > 0 && (
          ...
          <button
            ...
            title="Nạp tiền QR / Thẻ cào tự động"
          >
            <CreditCard className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
            <span className="hidden xs:inline">{t('nav_deposit')}</span>
            <span className="xs:hidden">{t('nav_deposit_short')}</span>
          </button>
          ...
          <div className="relative" ref={accountMenuRef}>
            <button
              ...
              title="Quản lý Tài Khoản, Ví Số Dư & Cài Đặt"
            >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="px-1 py-0.2 rounded text-[7px] sm:text-[8px] font-mono font-bold bg-amber-950 text-amber-300 border border-amber-500/50 uppercase shrink-0">
                            {user.role === 'admin' ? t('nav_role_admin') : t('nav_role_vip')}
                          </span>
                        </div>
                  ...
                  <div className="p-1.5 sm:p-2 bg-black/50 border-b border-slate-800/80 space-y-1 sm:space-y-1.5">
                    <div className="grid grid-cols-2 gap-1 sm:gap-1.5">
                      <div className="p-1 sm:p-1.5 rounded-lg bg-slate-900/90 border border-slate-800 flex items-center justify-between">
                        <span className="text-[8px] sm:text-[9px] text-slate-400 font-mono">{t('nav_available')}:</span>
                        <span className="text-[10px] sm:text-xs font-black font-mono text-emerald-400 truncate ml-1">
                          {formatCurrency(user.walletBalance, user.currency)}
                        </span>
                      </div>
                      <div className="p-1 sm:p-1.5 rounded-lg bg-slate-900/90 border border-slate-800 flex items-center justify-between">
                        <span className="text-[8px] sm:text-[9px] text-slate-400 font-mono">{t('nav_escrow')}:</span>
                  ...
                  <div className="p-1.5 space-y-0.5 font-mono text-xs">
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-white text-[11px] sm:text-xs">🌐 {t('nav_language_currency')}</span>
                      </div>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-white text-[11px] sm:text-xs">✨ Tất Cả Thư Mục (18 Tiện Ích)</span>
                      </div>
                      <span className="px-1.5 py-0.2 rounded text-[8px] bg-cyan-400 text-black font-black uppercase">
                        18 TOOLS
                      </span>
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <span>Nạp Game 121 Trò (API 3s)</span>
                      </div>
                    </button>
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <span>Vòng Quay May Mắn (Jackpot)</span>
                      </div>
                    </button>
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <span>Chính Sách Đại Lý (CTV)</span>
                      </div>
                      <span className="text-[10px] text-purple-300">Hoa hồng VIP</span>
                    </button>
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <span>Bảo Hành 1:1 & Khiếu Nại</span>
                      </div>
                    </button>
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <span>Bộ Công Cụ Tools Key</span>
                      </div>
                    </button>
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <span>Hướng Dẫn Bảo Lãnh Escrow</span>
                      </div>
                    </button>
