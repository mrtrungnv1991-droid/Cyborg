    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-mono">
              Thẻ Quà Tặng Số Mệnh Giá ${card.balance} {card.currency} (Đã Xác Thực)
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-slate-800 hover:bg-slate-700 text-xs font-mono text-cyan-300 border border-slate-700 transition-all disabled:opacity-50"
        >
          <RefreshCw className={`w-3.5 h-3.5 ${isCheckingBalance ? 'animate-spin text-cyan-400' : ''}`} />
          <span>{isCheckingBalance ? 'Đang Tra Cứu...' : 'Tra Cứu Số Dư Live'}</span>
        </button>
      </div>
      ...
      <div className="relative w-full max-w-lg mx-auto aspect-[1.586/1] rounded-2xl p-6 bg-gradient-to-br from-[#121624] via-[#0d101a] to-[#07090e] border border-cyan-500/30 shadow-[0_0_35px_rgba(6,182,212,0.15)] overflow-hidden flex flex-col justify-between select-none">
        ...
        <div className="relative z-10 flex items-start justify-between">
          ...
          <div className="text-right">
            <div className="text-[10px] font-mono text-slate-400 uppercase">Mệnh Giá Thẻ</div>
        ...
        <div className="relative z-10 my-auto">
          <div className="text-[10px] font-mono text-slate-400 uppercase mb-1">Mã Thẻ (Card Number)</div>
          <div className="relative p-3 rounded-lg bg-black/60 border border-slate-700 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-1.5 rounded bg-cyan-950 hover:bg-cyan-900 text-cyan-300 border border-cyan-500/40 transition-colors"
                title="Copy mã thẻ"
              >
        ...
        <div className="relative z-10 flex items-end justify-between pt-2 border-t border-white/10">
          <div className="flex items-center gap-4">
            <div>
              <div className="text-[9px] font-mono text-slate-400 uppercase">Mã PIN Bảo Mật</div>
            ...
            <div>
              <div className="text-[9px] font-mono text-slate-400 uppercase">Hạn Dùng</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-3">
          <div className="flex items-center gap-2 text-xs font-bold font-mono text-emerald-400">
            ...
            <span>KẾT QUẢ XÁC THỰC TỪ GIFTUP SERVER</span>
          </div>

          <div className="space-y-1.5 text-xs font-mono">
            <div className="flex justify-between py-1 border-b border-slate-800 text-slate-300">
              <span className="text-slate-500">Trạng Thái Số Dư:</span>
              <span className="text-emerald-400 font-bold">Khả dụng 100% (${card.balance}.00 USD)</span>
            </div>
            <div className="flex justify-between py-1 border-b border-slate-800 text-slate-300">
              <span className="text-slate-500">Phân Phối Bởi:</span>
        ...
        <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-3 flex flex-col justify-between">
          <div>
            <div className="text-xs font-bold font-mono text-cyan-400 flex items-center gap-1.5">
              ...
              <span>Hướng Dẫn Sử Dụng Thẻ</span>
            </div>
            <p className="text-xs text-slate-300 font-sans mt-1 leading-relaxed">
              Bạn có thể sử dụng thẻ này trực tiếp tại các ứng dụng, game hoặc website đối tác hỗ trợ GiftUp, hoặc nạp vào ví GiftUp cá nhân.
            </p>
          </div>
