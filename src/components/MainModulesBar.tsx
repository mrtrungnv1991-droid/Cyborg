...
export const MainModulesBar: React.FC<MainModulesBarProps> = ({
  ...
  const modules = [
    ...
    },
    {
      ...
      sub: 'Spotify, YouTube, ChatGPT, Canva Pro',
      icon: Users,
    ...
    },
    {
      ...
      title: 'Key Game (Steam / EA)',
      sub: 'FC 25, Elden Ring, Cyberpunk 2077',
      icon: Gamepad2,
    ...
    },
    {
      ...
      title: 'Key Ứng Dụng & Win',
      sub: 'Windows 11 Pro, Office 2024, IDM',
      icon: Key,
    ...
    },
    {
      ...
      title: 'Topup Nạp Game 3S',
      sub: 'Liên Quân, Free Fire, Genshin UID',
      icon: Zap,
    ...
    <div className="mb-6">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="hidden sm:flex items-center gap-1.5 text-xs text-slate-400 font-mono">
          ...
          <span>Bảo hành ký quỹ 100% Escrow</span>
        </div>
      </div>
