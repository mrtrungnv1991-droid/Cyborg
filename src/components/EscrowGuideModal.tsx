    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-3xl rounded-xl bg-[#0b0e17] border border-slate-700 shadow-2xl overflow-hidden my-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-bold font-mono text-white">
                QUY TRÌNH GOM ĐƠN & BẢO ĐẢM VÍ ESCROW
              </h2>
              <p className="text-xs text-slate-400 font-mono mt-0.5">
                Cơ chế bảo vệ 100% người mua và người bán theo tiêu chuẩn Cyber-Tesla
              </p>
            </div>
          </div>
        ...
        <div className="p-4 sm:p-6 space-y-6 max-h-[75vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-3 relative">
              ...
              <h4 className="text-sm font-bold font-mono text-white">1. Đặt Slot & Khóa Escrow</h4>
              <p className="text-xs text-slate-400 font-sans leading-relaxed">
                Người dùng chọn tham gia nhóm gom đơn (Group Pool). Tiền cọc được tạm khóa an toàn trong hợp đồng Escrow của sàn, chưa chuyển cho người bán.
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-3 relative">
              ...
              <h4 className="text-sm font-bold font-mono text-white">2. Gom Đủ Slot Tức Thì</h4>
              <p className="text-xs text-slate-400 font-sans leading-relaxed">
                Khi pool đạt đủ số người (VD: 5/5 slots), hệ thống tự động kích hoạt tiến trình giải phóng kho key và thẻ GiftUp chính hãng.
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-3 relative">
              ...
              <h4 className="text-sm font-bold font-mono text-white">3. Bung Key & Hoàn Tất</h4>
              <p className="text-xs text-slate-400 font-sans leading-relaxed">
                Mỗi thành viên nhận một mã key / profile riêng biệt trong Kho Key. Tiền được giải phóng cho người bán sau thời hạn bảo hành 24 giờ.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-black/60 border border-cyan-500/30 space-y-3">
            <div className="text-xs font-bold font-mono text-cyan-400 flex items-center gap-1.5 uppercase">
              ...
              <span>Chính Sách Cam Kết 3 Điểm Vàng</span>
            </div>

            <div className="space-y-2 text-xs font-mono text-slate-300">
              <div className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                <span><strong>Hoàn Tiền 100%:</strong> Nếu nhóm hết thời gian đếm ngược mà chưa đủ slot, tiền tự động mở khoá trả về ví trong 1 giây.</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                <span><strong>Kiểm Tra Key Trước (Pre-Validation):</strong> Mọi mã Steam, GiftUp hay OpenAI đều được nạp sẵn vào kho bảo mật trước khi mở pool.</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                <span><strong>Bảo Hành 1 Đổi 1:</strong> Hỗ trợ khiếu nại và đổi key mới ngay lập tức nếu xảy ra lỗi kích hoạt.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 border-t border-slate-800 bg-[#0a0d14] flex items-center justify-end">
          <button
            onClick={onClose}
            className="py-2.5 px-6 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-black font-mono font-bold text-xs uppercase tracking-wider transition-all"
          >
            Đã Hiểu & Tiếp Tục
          </button>
        </div>
