                  ...
                  return (
                    <button
                      ...
                      className={`p-3.5 rounded-xl border text-left transition-all flex items-center justify-between gap-3 cursor-pointer ${
                        isSelected
                          ? 'bg-gradient-to-r from-cyan-950/90 via-[#0c182b] to-slate-900 border-cyan-400 shadow-[0_0_20px_rgba(6,182,212,0.25)]'
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-2 text-[10px] font-mono text-slate-400 mt-0.5">
                            <span className="text-cyan-400">Tiền tệ mặc định: {lang.defaultCurrency}</span>
                          </div>
                        </div>
                      </div>

                      {isSelected ? (
                        <div className="w-6 h-6 rounded-full bg-cyan-500 text-black flex items-center justify-center shrink-0 shadow-sm">
