      ...
      <div className="relative w-full max-w-lg rounded-2xl bg-[#090c15] border border-cyan-500/40 shadow-[0_0_50px_rgba(6,182,212,0.3)] overflow-hidden font-mono text-xs">
        ...
        <div className="p-5 space-y-4 max-h-[65vh] overflow-y-auto bg-[#06080e]/90 text-slate-300 leading-relaxed">
          <div className="p-3.5 rounded-xl bg-cyan-950/30 border border-cyan-500/30 text-cyan-200 space-y-2">
            <div className="flex items-center gap-2 text-white font-bold text-xs">
              ...
              <span>{config.slogan || 'SÀN GOM ĐƠN SỈ & BẢO LÃNH TÀI NGUYÊN SỐ 1 VIỆT NAM'}</span>
            </div>
            <p className="text-[11px] text-slate-300">
              Chào mừng bạn đến với sàn CyberPool. Hệ thống nạp tiền VietQR tự động 24/7, gạch thẻ cào TheSieuRe chiết khấu tốt nhất và bảo lãnh Escrow an toàn 100%.
            </p>
          </div>
          ...
          <div className="space-y-2.5 text-[11px] text-slate-300">
            <div className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">Bảo hiểm Escrow:</strong> Tiền mua được giữ an toàn tại ví sàn trung gian. Bạn chỉ xác nhận giải ngân khi key/tài khoản hoạt động chính xác.
              </span>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">Nạp tiền tự động:</strong> VietQR MBBank và thẻ cào viễn thông được cộng số dư chỉ sau 3 - 30 giây.
              </span>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">Chương trình CTV:</strong> Hoa hồng lên tới 8% cho mỗi lượt chia sẻ mua hàng qua link Affiliate.
              </span>
            </div>
          </div>
        ...
        <div className="p-4 bg-slate-950 border-t border-slate-800 flex items-center justify-between gap-3">
          <button
            ...
            className="px-3 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-cyan-300 font-bold text-xs flex items-center gap-1.5 transition-all"
          >
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black font-bold text-xs uppercase tracking-wider transition-all"
          >
            Đã Hiểu & Vào Web
          </button>
        </div>
